...
>
    ...
    <p><enhanced:img src="/static/photos/svycarske-dobrodruzstvi/sklad.jpg" alt=""></p>

    <p>A mezi tím vším, SGI poklad - důvod našeho výjezdu:

    <p><enhanced:img src="/static/photos/svycarske-dobrodruzstvi/sklad2.jpg" alt=""></p>
