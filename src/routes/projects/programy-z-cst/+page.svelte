<script lang="ts">
    ...
    let krc = [{id: 1, text: "Program z 1. dílu seriálu generuje n-tice čísel, která se krátce objeví na obrazovce. Na hráčstvu je, aby tato čísla stihlo přečíst.", text_en: "The program from episode 1 of the series generates n-tuples of numbers that briefly appear on the screen. It is up to the player to read these numbers in time."},
               ...
               {id: 3, text: "Program z 3. dílu seriálu generuje n-tice znaků, které se krátce objeví na obrazovce. Na hráčstvu je, aby tato čísla a písmena stihlo přečíst.", text_en: "The program from episode 3 of the series generates n-tuples of characters that briefly appear on the screen. It is up to the player to read these characters in time."},
               {id: 4, text: "Program z 4. dílu seriálu zobrazuje krátké texty, které se krátce objeví na obrazovce. Na hráčstvu je, aby tyto texty stihlo přečíst.", text_en: "The program from episode 4 of the series displays short texts that briefly appear on the screen. It is up to the player to read these texts in time."},
               {id: 5, text: "Program z 5. dílu seriálu generuje dvojskupiny po třech znacích, mezi kterými musí hráčstvo najít co nejrychleji všechny rozdíly.", text_en: "The program from episode 5 of the series generates pairs of three-character groups, in which the player must quickly find all the differences."},
               {id: 7, text: "Program z 7. dílu seriálu zobrazí dva sloupce slov, které musí hráčstvo přečíst co nejrychleji.", text_en: "The program from episode 7 of the series displays two columns of words that the player must read as quickly as possible."},
               {id: 8, text: "Program z 8. dílu seriálu trénuje diváctvo v selektivním čtení – hráčstvo si má všímat všech čísel v textu a zapamtovat si je.", text_en: "The program from episode 8 of the series trains viewers in selective reading — the player must notice all numbers in the text and remember them."},
               {id: 10, text: "Program z 10. dílu vypíše na obrazovce text, který musí hráčstvo v omezeném čase přečíst a pak odpovědět na otázky, vztahující se k tomuto textu.", text_en: "The program from last episode displays a text on the screen that the player must read within a limited time and then answer questions related to the text."}
            ]
    let pd = [{id: 1, program: "Hlavní část programu", program_en: "The main part of a program", text: "Část programu z 1. epizody tvoří základ pro celý program – díky němu celý program drží pohromadě a zároveň mu dodává hlavní menu.", text_en: "A part of the program from episode 1 serves as the foundation for the entire program — it holds everything together and also provides the main menu."},
              {id: 2, program: "Program Adresář", program_en: "Program called Adress book", text: "Část programu z 2. epizody umožňuje uživatelstvu vést si seznam lidí, včetně jejich data narození, adresy a telefoního čísla.", text_en: "A part of the program from episode 2 allows users to keep a list of people, including their date of birth, address, and phone number."},
              {id: 3, program: "Program Mám půjčeno", program_en: "Program called I have borrowed", text: "Tato část programu ze 3. epizody pořadu umožňuje uživatelstvu vést si seznam půjčených věcí a propojit ho s konkrétní osobou z Adresáře.", text_en: "This part of the program from episode 3 of the show allows users to keep a list of borrowed items and link them to a specific person from the Address Book."},
              {id: 4, program: "Program Půjčil jsem", program_en: "Program called I have lent", text: "Část programu ze 4. epizody pořadu umožňuje vést si seznam uživatelstvem půjčených věcí a propojit ho s konkrétní osobou z Adresáře.", text_en: "This part of the program from episode 4 of the show allows users to keep a list of borrowed items and link them to a specific person from the Address Book."},
              {id: 5, program: "Program Seznam událostí", program_en: "Program called List of events", text: "Část programu z 5. epizody umožňuje uživatelstvu vést si seznam všech událostí které proběhly nebo mají proběhnout.", text_en: "A part of the program from episode 5 allows users to keep a list of all events that have taken place or are about to take place."},
              {id: 6, program: "Program Jmeniny", program_en: "Program called Name day", text: "Tato část programu ze 6. epizody funguje jako kalendář všech svátků – uživatelstvo zadá datum a program mu napíš, kdo má v dané datum svátek.", text_en: "This part of the program from episode 6 functions as a calendar of all holidays — users enter a date, and the program tells them whose name day it is on that date."},
              {id: 7, program: "Program Východy a západy slunce", program_en: "Program called Sunrises and Sunsets", text: "Část programu ze 7. epizody umožňuje uživatelstvu spočítat na základě data a polohy v kolik hodin výjde a zapadne slunce.", text_en: "A part of the program from episode 7 allows users to calculate the time of sunrise and sunset based on the date and location."},
              {id: 8, program: "Program Zásoby doma", program_en: "Program Home supplies", text: "Tato část programu z 8. epizody umožňuje uživatesltvu vést seznam všech zásob u nich doma.", text_en: "This part of the program from episode 8 allows users to maintain a list of all their home supplies."},
              {id: 9, program: "Program Poznámky", program_en: "Program called Notes", text: "Část programu z 9. epizody umožňuje uživatesltvu vést si vlastní poznámky.", text_en: "A part of the program from episode 9 allows users to take their own notes."},
              {id: 10, program: "Hlavní část programu", program_en: "The main part of a program", text: "Část programu z 10. epizody je stejná jako část vysílaná v první epizodě.", text_en: "A part of the program from last episode serves as the foundation for the entire program — it holds everything together and also provides the main menu."}
            ]
</script>
...
<article class="thin">
    ...
    <p><Loc
        cs="V roce 2023 Herní archiv od České televize koupil všechny dostupné kopie dílů pořadů <i>Kurz rychlého čtení</i> a <i>Počítačová dilemata</i> a v roce 2025 převedl a zveřejnil všechny programy pro ZX Spectrum z konců epizod těchto pořadů."
    ...
    <h3><Loc
        cs="Programy z <i>Kurzu rychlého čtení</i>"
        en="Programs from <i>Kurzu rychlého čtení</i>"
    />
    </h3>
    <p><Loc
        cs="Programy z konců epizod <i>Kurzu rychlého čtení</i> byli drobnými herními hříčkami, které měly diváctvu pomoci s procvičováním technik rychlého čtení. Díl 6 a 9 se bohužel nedochovali. <a href='https://www.prazskyden.cz/tento-muz-v-roce-1986-predpovedel-soucasny-internet-ted-prozradil-co-se-chysta-v-budoucnu/'>Podle Davida Grubera</a> všechny tyto hry dělal Ing. Milan Buchta."
        en="The programs from the endings of the episodes of <i>Kurz rychlého čtení</i> were small game-like exercises designed to help viewers practice speed-reading techniques. Unfortunately, episodes 6 and 9 have not been preserved. <a href='https://www.prazskyden.cz/tento-muz-v-roce-1986-predpovedel-soucasny-internet-ted-prozradil-co-se-chysta-v-budoucnu/'>According to David Gruber</a>, all these games were created by Ing. Milan Buchta."
    />
    </p>
    {#each krc as krc (krc.id)}
        <div class="file">
            <div class="row">
            <div class="file-text">
                <div class="file-name">
                    <a href="/files/programy-od-cst-krc/KRC_{ krc.id  }.tzx" download>
                        <LucideDownload style="vertical-align: bottom; width: 25px; height: 25px; margin-right: 4px;"/><Loc
                        cs="Rychlé čtení – { krc.id  }. díl"
                        en="Episode { krc.id }"
                        />
                    </a>
                </div>
    ...
    {/each}
    <h3><Loc
        cs="Program z <i>Počítačových dilemat</i>"
        en="Program from <i>Počítačová dilemata</i>"
    />
    </h3>
    <p><Loc
