...
<Interview data={data}>
    {#snippet content()}
        ...
        <A speaker={FS}>
            Ale hlavně, když měl počítač ten DText, což byl tehdy takový předobraz T602. Všechno bylo ve sloupcích a písmena měla takovou osmidírkovou podobu. Z toho byla celá abeceda a tak to tisklo. Takže tohleto jsme použili jako první, abychom si mohli lámat. Ono to umělo zezadu zalomit, což u psacího stroje nikdy neuděláte. S tím jsme si hodně pohráli. Potom se na tom daly dělat i větší písmena a nadpisy. Znalo to sice jenom dva druhy zvětšení, ale už to byl pokrok. Pak jsme pochopilil, že se k tomu dá i něco nakreslit, takže jsem dal výtvarníkům tu blánu, ať tam něco nakreslí. Takže jsem měli tu matrici takovou vyzáplatovanou. Měli jsme na počítači sloupce a v tom kresby. Tohle jsme udělali prvně ve Vokně z roku 1986 <em>(č. 11 – pozn. JŠ)</em>.
        </A>
        ...
        <A speaker={FS}>
            Ten program Kniha někde určitě mám. Mám ještě doma padesát kazet, na kterých jsem měl různý programy. Nejdřív to ale musím spustit Spectrum, abych to našel.
        </A>
